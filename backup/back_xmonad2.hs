...
myStatusBar = "conky -c /home/augusto/.xmonad/.conky_dzen | dzen2 -x '2080' -w '1040' -h '24' -ta 'r' -bg '#1B1D1E' -fg '#FFFFFF' -y '0'"
myBitmapsDir = "/home/augusto/.icons/stlarch"
--}}}
-- Main {{{
main = do
...
myLogHook h = dynamicLogWithPP $ defaultPP
    {
      ...
      , ppLayout            =   dzenColor "#ebac54" "#1B1D1E" .
                                (\x -> case x of
                                    "ResizableTall"             ->      "^i(" ++ myBitmapsDir ++ "/ntile.xbm)"
                                    "Mirror ResizableTall"      ->      "^i(" ++ myBitmapsDir ++ "/nbstac.xbm)"
                                    "Full"                      ->      "^i(" ++ myBitmapsDir ++ "/monocle2.xbm)"
                                    "Simple Float"              ->      "~"
                                    _                           ->      x
                                )
...
keys' conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    --, ((modMask,                    xK_q        ), spawn "killall conky dzen2 && /home/augusto/.cabal/bin/xmonad --recompile && /home/augusto/.cabal/bin/xmonad --restart")
    ]
    ++
